...
const WhatSetsApart: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-black relative overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24 reveal-skew">
          <p className="text-gray-700 text-[9px] sm:text-[10px] md:text-xs font-black uppercase tracking-[0.6em] sm:tracking-[0.8em] mb-3 sm:mb-4">DISTINCTION</p>
